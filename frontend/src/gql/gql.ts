...
type Documents = {
    ...
    "\n  query TraceById($traceId: ID!) {\n    trace(traceId: $traceId) {\n      traceId\n      serviceName\n      spanCount\n      startTime\n      durationMs\n      rootSpan {\n        name\n        kind\n        statusCode\n        durationMs\n      }\n      spans {\n        ...SpanFields\n      }\n    }\n  }\n": typeof types.TraceByIdDocument,
