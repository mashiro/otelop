...
const emptyMediaVariants = cva(
  "mb-2 flex shrink-0 items-center justify-center [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    ...
    compoundVariants: [
      { variant: "signal", tone: "trace", className: "bg-trace/10" },
      { variant: "signal", tone: "metric", className: "bg-metric/10" },
      { variant: "signal", tone: "log", className: "bg-log/10" },
    ],
    defaultVariants: {
      variant: "default",
    },
